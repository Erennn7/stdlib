...
*/
declare function sliceDimensionTo( x: float64ndarray, dim: number, stop: number, options?: Options ): float64ndarray;
...
* // returns [ [ 1.0, 2.0 ], [ 3.0, 4.0 ] ]
*/
declare function sliceDimensionTo( x: float32ndarray, dim: number, stop: number, options?: Options ): float32ndarray;
...
* // returns [ [ 1.0, 2.0 ], [ 3.0, 4.0 ] ]
*/
declare function sliceDimensionTo( x: float16ndarray, dim: number, stop: number, options?: Options ): float16ndarray;
...
* // returns [ [ 1, 2 ], [ 3, 4 ] ]
*/
declare function sliceDimensionTo( x: int32ndarray, dim: number, stop: number, options?: Options ): int32ndarray;
...
* // returns [ [ 1, 2 ], [ 3, 4 ] ]
*/
declare function sliceDimensionTo( x: int16ndarray, dim: number, stop: number, options?: Options ): int16ndarray;
...
* // returns [ [ 1, 2 ], [ 3, 4 ] ]
*/
declare function sliceDimensionTo( x: int8ndarray, dim: number, stop: number, options?: Options ): int8ndarray;
...
* // returns [ [ 1, 2 ], [ 3, 4 ] ]
*/
declare function sliceDimensionTo( x: uint32ndarray, dim: number, stop: number, options?: Options ): uint32ndarray;
...
* // returns [ [ 1, 2 ], [ 3, 4 ] ]
*/
declare function sliceDimensionTo( x: uint16ndarray, dim: number, stop: number, options?: Options ): uint16ndarray;
...
* // returns [ [ 1, 2 ], [ 3, 4 ] ]
*/
declare function sliceDimensionTo( x: uint8ndarray, dim: number, stop: number, options?: Options ): uint8ndarray;
...
* // returns [ [ 1, 2 ], [ 3, 4 ] ]
*/
declare function sliceDimensionTo( x: uint8cndarray, dim: number, stop: number, options?: Options ): uint8cndarray;
...
* // returns [ 2, 2 ]
*/
declare function sliceDimensionTo( x: complex128ndarray, dim: number, stop: number, options?: Options ): complex128ndarray;
...
* // returns [ 2, 2 ]
*/
declare function sliceDimensionTo( x: complex64ndarray, dim: number, stop: number, options?: Options ): complex64ndarray;
...
* // returns [ [ 1, 2 ], [ 3, 4 ] ]
*/
declare function sliceDimensionTo<T = unknown>( x: genericndarray<T>, dim: number, stop: number, options?: Options ): genericndarray<T>;
...
* // returns [ [ 1, 2 ], [ 3, 4 ] ]
*/
declare function sliceDimensionTo<T = unknown>( x: typedndarray<T>, dim: number, stop: number, options?: Options ): typedndarray<T>;
