...
tape( 'the function returns an uninitialized array (dtype=float16, base)', function test( t ) {
	var arr;
	var x;
...
tape( 'the function returns an uninitialized array (dtype=float16, non-base)', function test( t ) {
	var arr;
	var x;
